...
function start(){
    ...
    function boom(){
        ...
        if (frecuencia2%2==0){
            ...
            ctx.fillText("Puntuación: "+puntuacion_local+"...haz click para una nueva partida", 500,30);
            ctx.font="20px Arial";
            ctx.fillStyle="Blue";
            ctx.textAlign="center";
        }
    ...
    //letiable de control de la velocidad de juego/movimiento
    let velocidad_juego=1;
    ...
    //letiable que me permite controlar el ancho del corte de la secuencia Sprite
    let personaje =  0;
    //Esta letiable se va a incrementar a 60fps en el animationFrame, me sirve de control de tiempo
    let frecuencia1 = 0;
    let puntuacion_local=0;
    function tiempo() {
        ...
        ctx.fillStyle="Blue";
        ctx.textAlign="center";
        //Esta letiable se va a incrementar 60 veces por segundo controlando el ciclo de puntuación global
        frecuencia1+=1;
    }
    /*===============================================================================================
